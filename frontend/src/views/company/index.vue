      ...
      <div class="container-box-private">
        <div class="box-infor-private">
          ...
          <div class="flex-input">
            ...
            <div class="age">
              <label>Phone*</label>
              <input type="text" v-model="updateI.phone" />
            </div>
          </div>
          <div class="flex-input">
            <div class="name">
              <label>Tax code*</label>
              <input v-model="updateI.taxCode" type="text" />
            </div>
            <div class="age">
              <label>Number employees</label>
              <input type="text" v-model="updateI.numberEmployees" />
            </div>
          </div>
          <div class="flex-input">
            <div class="name">
              <label>Address*</label>
              <input v-model="updateI.address" type="text" />
            </div>
            <div class="age">
              <label>Link website</label>
              <input type="text" v-model="updateI.linkWebsite" />
            </div>
          </div>
          <div class="flex-input">
						<div class="name">
							<label>Background</label>
							<input v-model="updateI.background" type="text" />
						</div>
          </div>
          <div class="flex-input">
						<div class="age">
							<label>Certification documents*</label>
              <input type="text" v-model="updateI.certificationDocuments" />
            </div>
          </div>
...
import NavBar from "../../layouts/NavBar/company/index.vue";
import { ref, onBeforeMount, watch } from "vue";
import { updateInfo, getInfo } from "@/services/user.service";
import { IUpdateCompany, ILogin } from "@/types/user";
...
const dataInfo = ref<IUpdateCompany>();
...
const updateI = ref<IUpdateCompany>({
  name: dataInfo.value?.name,
  avatar: dataInfo.value?.avatar,
  phone: dataInfo.value?.phone,
  numberEmployees: dataInfo.value?.numberEmployees,
  email: dataInfo.value?.email,
  taxCode: dataInfo.value?.taxCode,
  address: dataInfo.value?.address,
  linkWebsite: dataInfo.value?.linkWebsite,
  certificationDocuments: dataInfo.value?.certificationDocuments,
});
