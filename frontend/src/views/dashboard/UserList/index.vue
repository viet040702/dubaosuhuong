...
const getStatusText = (isVerified: boolean) => {
  return isVerified
    ? '<span style="border: green; background-color: #b7b8bb; color: green;">Verified</span>'
    : '<span style="border: red; background-color: #b7b8bb; color: red;">Not verified</span>';
};
onBeforeMount(() => {
  getListUser();
});
